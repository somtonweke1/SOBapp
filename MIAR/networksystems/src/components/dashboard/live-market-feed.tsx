...
import { TrendingUp, TrendingDown, RefreshCw, Activity, Droplet, CheckCircle, Database, MapPin, Beaker, ThermometerSun } from 'lucide-react';
 ...
 */
const LiveMarketFeed: React.FC<LiveMarketFeedProps> = ({ onPathwayChange }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Pathway Position */}
      <PathwayIndicator currentStep="monitoring" onStepChange={onPathwayChange} />
