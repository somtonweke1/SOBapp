...
export const metadata: Metadata = {
  title: 'SOBapp Infrastructure - Strategic Intelligence for Capital-Intensive Supply Chains | SOBapp',
  description:
...
export default function SOBappInfrastructurePage() {
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-950/10 backdrop-blur-sm rounded-full mb-6">
              <Zap className="w-4 h-4" />
              <span className="text-sm font-medium">Powered by SOBapp Platform</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              SOBapp Infrastructure
            </h1>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Pillar 1 */}
          <div className="bg-slate-950 rounded-2xl shadow-lg p-8 border border-slate-800 hover:shadow-xl transition-shadow">
            ...
            <p className="text-sm text-slate-500 mb-4">The Intelligence Engine</p>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-blue-400 font-semibold mt-6 hover:gap-3 transition-all"
            >
              Learn More
          ...
          <div className="bg-slate-950 rounded-2xl shadow-lg p-8 border border-slate-800 hover:shadow-xl transition-shadow">
            ...
            <p className="text-sm text-slate-500 mb-4">The Data Fabric</p>
            <p className="text-slate-400 mb-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-emerald-300 font-semibold mt-6 hover:gap-3 transition-all"
            >
              Learn More
              <ArrowRight className="w-4 h-4" />
            </Link>
          ...
          <div className="bg-slate-950 rounded-2xl shadow-lg p-8 border border-slate-800 hover:shadow-xl transition-shadow">
            ...
            <p className="text-sm text-slate-500 mb-4">The Expertise Layer</p>
            <p className="text-slate-400 mb-6">
              Human-in-the-loop domain knowledge from former Baltimore property executives,
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Module 1 */}
            <div className="bg-slate-950 rounded-xl shadow-md p-8 border border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                <Target className="w-8 h-8 text-orange-600" />
                <div>
                  <h3 className="text-xl font-bold text-slate-100">Module 1</h3>
                  <p className="text-sm text-slate-500">Baltimore Property Focus</p>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-800">
                <p className="text-sm font-semibold text-slate-100 mb-2">Target Results:</p>
            ...
            <div className="bg-slate-950 rounded-xl shadow-md p-8 border border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-100">Module 2</h3>
                  <p className="text-sm text-slate-500">Cross-Industry</p>
                </div>
              </div>
              <h4 className="text-lg font-semibold text-slate-100 mb-2">
                Strategic Sourcing
            ...
            <div className="bg-slate-950 rounded-xl shadow-md p-8 border border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-100">Module 3</h3>
                  <p className="text-sm text-slate-500">Executive Focus</p>
                </div>
              </div>
              <h4 className="text-lg font-semibold text-slate-100 mb-2">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-12 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Baltimore Property Case */}
            <div className="bg-slate-950/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
              <div className="flex items-center gap-3 mb-4">
                <Globe className="w-8 h-8" />
                <h3 className="text-xl font-bold">Large Copper Producer</h3>
              </div>
              <p className="text-emerald-100 mb-6">
                Tier 1 Baltimore Property Company | 5 mines, 2 smelters, global distribution
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-slate-950 text-emerald-300 border-2 border-emerald-600 rounded-lg font-semibold hover:bg-emerald-950 transition-colors"
            >
              Contact Sales
            </Link>
          </div>
