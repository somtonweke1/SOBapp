...
class EmailService {
  ...
  public initializeFromEnv() {
    const config: EmailConfig = {
      from: process.env.SMTP_FROM || 'MIAR Platform <noreply@miar.platform>',
...
<body>
  ...
  <div class="email-body">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <p style="color: #666; font-size: 14px;">
        Generated by MIAR Platform BIS Entity List Scanner<br>
  ...
  <div class="footer">
    ...
    <p>
      This is an automated email from MIAR Platform. Please do not reply to this email.
    </p>
  </div>
</body>
</html>
...
Generated by MIAR Platform BIS Entity List Scanner
    `.trim();
  }
